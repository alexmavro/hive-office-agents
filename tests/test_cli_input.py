...
def mock_prompt_session():
    ...
    with patch("hive.cli.commands._PROMPT_SESSION", mock_session), \
         patch("hive.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("hive.cli.commands.PromptSession") as MockSession, \
         patch("hive.cli.commands.FileHistory") as MockHistory, \
